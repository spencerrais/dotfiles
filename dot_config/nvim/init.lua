...
vim.keymap.set('n', '<leader>a', function()
  ...
  -- Otherwise, create and open the floating terminal
  ...
  aider_win = vim.api.nvim_open_win(aider_buf, true, {
    relative = 'editor',
    row = row,
    col = col,
    width = width,
  ...
  vim.fn.termopen("aider " .. vim.fn.fnameescape(file))
  vim.cmd("startinsert")
end, { desc = "Toggle Aider popup on current file" })
